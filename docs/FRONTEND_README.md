...
- `index.js` - Data loading and display logic

**Usage:**
```
http://localhost/anas/index.html
```
...
- **Dashboard:** `http://localhost/anas/index.html`
...
| Dashboard | `index.html` | `index.css` | `index.js` |
